...
{
    /// <inheritdoc />
    public partial class InitialCreateAndSecurity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_SubscriptionId_Period_IsSuccessful",
                table: "Payments",
                columns: new[] { "SubscriptionId", "Period", "IsSuccessful" },
                unique: true,
                filter: "[IsSuccessful] = 1");
